      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-24">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            với sức mạnh của thời đại, tạo nên sức mạnh tổng hợp cho cách mạng Việt Nam.
          </p>
        </motion.div>
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              giải phóng dân tộc ở Việt Nam chỉ có thể giành thắng lợi khi gắn bó
              chặt chẽ với phong trào cách mạng tiến bộ trên toàn thế giới.
            </p>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Theo Hồ Chí Minh, sức mạnh dân tộc là những giá trị nội sinh bền vững
              như lòng yêu nước, ý thức tự lực tự cường và ý chí đấu tranh kiên cường.
              Bên cạnh đó, sức mạnh thời đại bao gồm phong trào giải phóng dân tộc,
              phong trào công nhân quốc tế, sự ủng hộ của các lực lượng tiến bộ
              và thành tựu khoa học – kỹ thuật.
            </p>
            <p className="text-muted-foreground">
              Việc kết hợp hài hòa hai nguồn sức mạnh này tạo nên
              <span className="text-gold font-semibold"> sức mạnh tổng hợp </span>
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Hồ Chí Minh cho rằng đoàn kết quốc tế không chỉ nhằm phục vụ thắng lợi
              của cách mạng Việt Nam, mà còn góp phần vào sự nghiệp chung của toàn
              nhân loại tiến bộ. Nhân dân Việt Nam không chỉ đấu tranh cho độc lập,
              tự do của dân tộc mình mà còn vì hòa bình, dân chủ và chủ nghĩa xã hội
        ...
        >
          ...
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
            Đoàn kết quốc tế phải được xây dựng trên cơ sở độc lập, tự chủ,
            bình đẳng và tôn trọng lẫn nhau, hướng tới mục tiêu hòa bình
            và tiến bộ xã hội.
          </p>
        </motion.section>
        ...
        >
          <div className="inline-block bg-gradient-to-r from-red/30 via-gold/30 to-red/30 border border-gold rounded-xl px-10 py-6">
            <h3 className="font-serif text-2xl md:text-3xl font-bold">
              ĐỘC LẬP DÂN TỘC GẮN LIỀN<br />VỚI CHỦ NGHĨA XÃ HỘI
            </h3>
          </div>
        </motion.div>
      </div>
